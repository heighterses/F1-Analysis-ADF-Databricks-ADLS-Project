...
results_deduped_df = final_df.dropDuplicates(['race_year', 'driver_name'])
...
merge_delta_data(results_deduped_df, 'f1_presentation', 'driver_standings', presentation_folder_path, merge_condition, 'race_year')
